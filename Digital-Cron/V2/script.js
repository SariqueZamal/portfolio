document.addEventListener('DOMContentLoaded', () => {
    ...
    // 6. Lazy Load Cal.com Embed on User Interaction
    let calLoaded = false;
    function lazyLoadCal() {
        ...
        // Remove listeners
        window.removeEventListener('scroll', lazyLoadCal);
        window.removeEventListener('mousemove', lazyLoadCal);
        window.removeEventListener('touchstart', lazyLoadCal);
        window.removeEventListener('keydown', lazyLoadCal);
    ...
    // Bind listeners
    window.addEventListener('scroll', lazyLoadCal, { passive: true });
    window.addEventListener('mousemove', lazyLoadCal, { passive: true });
    window.addEventListener('touchstart', lazyLoadCal, { passive: true });
    window.addEventListener('keydown', lazyLoadCal, { passive: true });
});
